...
**Reference documents:**
- `PROJECT_OVERVIEW.md` — technical design, public API, configuration options, and v1 scope.
- `DOCS_PLAN.md` — documentation site architecture, hosting, and page content plan.
- `mock-data-example.ts` — canonical example of the core data generation API.
- `playwright-example.ts` — canonical example of the MSW/Playwright API.
